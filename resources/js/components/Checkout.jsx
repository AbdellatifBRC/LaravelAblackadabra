...
const Checkout = () => {
    ...
    const [language, setLanguage] = useState(window.location.pathname.includes('en-us'));
    ...
    useEffect(() => {
        axios.get("/carts").then((res) => {
            ...
            setLoading(false);
            console.log(window.location.pathname.includes('en-us'))
        });
    ...
    return (
        <>
            ...
            {language?<h4 className="mb-5">معلومات عن الزبون</h4>:<h4 className="mb-5">Billing Details</h4>}
                            ...
                            <div className="checkout__input">
                                ...
                                >
                                    ...
                                    {/* {provinces.map((province, index) => {
                                        return ( */}
                                        <option key={1} value={'algeirs'}>{'algeirs'}</option>
                                        <option key={2} value={'oran'}>{'oran'}</option>
                                        <option key={3} value={'annaba'}>{'annaba'}</option>
                                        {/* );
                                    })} */}
                                </select>
                            </div>
