        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.products.store') }}" method="post">
                    ...
                    <div class="form-group">
                        <label for="price">Crossed Out Price</label>
                        <input type="number" name="prixbare" value="{{ old('prixbare') }}" class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="weight">sizes</label>
                        <select class="selectpicker" multiple="multiple" data-live-search="true" name="size[]">
